...
## Project Structure
    ...
    ├── ideapros_llc_notio_31949  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_notio_31949`
...
2. Clone this repo and `cd ideapros_llc_notio_31949`
